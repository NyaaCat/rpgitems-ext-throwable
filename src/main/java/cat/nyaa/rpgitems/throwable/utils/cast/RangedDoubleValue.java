package cat.nyaa.rpgitems.throwable.utils.cast;

import cat.nyaa.rpgitems.throwable.utils.Utils;
import cat.nyaa.rpgitems.throwable.utils.WeightedPair;
...
public class RangedDoubleValue {
    ...
    public double random(){
        WeightedPair<Double, Double> pair = Utils.weightedRandomPick(ranges);
